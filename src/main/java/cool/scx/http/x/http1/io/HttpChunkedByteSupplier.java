...
/// @author scx567888
/// @version 0.0.1
public final class HttpChunkedByteSupplier implements ByteSupplier {
    ...
    public ByteChunk doReadChunkSize() throws ScxIOException {
        // 1, 读取 分块长度
    ...
    public ByteChunk doReadChunkData() throws ScxIOException {
    ...
    public ByteChunk doReadTail() throws ScxIOException {
        byte[] endBytes;
        try {
